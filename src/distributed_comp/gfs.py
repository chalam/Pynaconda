...
# https://clouddbs.blogspot.ch/2010/11/gfs-google-file-system-in-199-lines-of.html
# GFS consists of three components: a client, a master, and one or more chunkservers
class GFSClient:
