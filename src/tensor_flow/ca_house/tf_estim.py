...
# scaling for ease of learning rates in a range that we usually use.
...
# preprocess the data, as well as how to batch, shuffle, and repeat it during model training.
...
# The first thing we can do is take a look at how well our predictions match our targets,
